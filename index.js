...
function generatePoem(event) {
  ...
  let context =
    "You are a very good poet and like to write short poems. You are to write a four line poem in basic html. Sign the poem with 'SheCodes AI' in a <strong> element. Please follow the users instructions";
